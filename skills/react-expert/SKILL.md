...
|-------|-----------|-----------|
| Server Components | `~/.cursor/skills/react-expert/references/server-components.md` | RSC patterns, Next.js App Router |
| React 19 | `~/.cursor/skills/react-expert/references/react-19-features.md` | use() hook, useActionState, forms |
| State Management | `~/.cursor/skills/react-expert/references/state-management.md` | Context, Zustand, Redux, TanStack |
| Hooks | `~/.cursor/skills/react-expert/references/hooks-patterns.md` | Custom hooks, useEffect, useCallback |
| Performance | `~/.cursor/skills/react-expert/references/performance.md` | memo, lazy, virtualization |
| Testing | `~/.cursor/skills/react-expert/references/testing-react.md` | Testing Library, mocking |
| Class Migration | `~/.cursor/skills/react-expert/references/migration-class-to-modern.md` | Converting class components to hooks/RSC |
