...
|-------|-----------|-----------|
| Architecture Patterns | `~/.cursor/skills/architecture-designer/references/architecture-patterns.md` | Choosing monolith vs microservices |
| ADR Template | `~/.cursor/skills/architecture-designer/references/adr-template.md` | Documenting decisions |
| System Design | `~/.cursor/skills/architecture-designer/references/system-design.md` | Full system design template |
| Database Selection | `~/.cursor/skills/architecture-designer/references/database-selection.md` | Choosing database technology |
| NFR Checklist | `~/.cursor/skills/architecture-designer/references/nfr-checklist.md` | Gathering non-functional requirements |
