...
|-------|-----------|-----------|
| App Router | `~/.cursor/skills/nextjs-developer/references/app-router.md` | File-based routing, layouts, templates, route groups |
| Server Components | `~/.cursor/skills/nextjs-developer/references/server-components.md` | RSC patterns, streaming, client boundaries |
| Server Actions | `~/.cursor/skills/nextjs-developer/references/server-actions.md` | Form handling, mutations, revalidation |
| Data Fetching | `~/.cursor/skills/nextjs-developer/references/data-fetching.md` | fetch, caching, ISR, on-demand revalidation |
| Deployment | `~/.cursor/skills/nextjs-developer/references/deployment.md` | Vercel, self-hosting, Docker, optimization |
