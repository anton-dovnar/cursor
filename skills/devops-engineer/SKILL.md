...
|-------|-----------|-----------|
| GitHub Actions | `~/.cursor/skills/devops-engineer/references/github-actions.md` | Setting up CI/CD pipelines, GitHub workflows |
| Docker | `~/.cursor/skills/devops-engineer/references/docker-patterns.md` | Containerizing applications, writing Dockerfiles |
| Kubernetes | `~/.cursor/skills/devops-engineer/references/kubernetes.md` | K8s deployments, services, ingress, pods |
| Terraform | `~/.cursor/skills/devops-engineer/references/terraform-iac.md` | Infrastructure as code, AWS/GCP provisioning |
| Deployment | `~/.cursor/skills/devops-engineer/references/deployment-strategies.md` | Blue-green, canary, rolling updates, rollback |
| Platform | `~/.cursor/skills/devops-engineer/references/platform-engineering.md` | Self-service infra, developer portals, golden paths, Backstage |
| Release | `~/.cursor/skills/devops-engineer/references/release-automation.md` | Artifact management, feature flags, multi-platform CI/CD |
| Incidents | `~/.cursor/skills/devops-engineer/references/incident-response.md` | Production outages, on-call, MTTR, postmortems, runbooks |
