...
|-------|-----------|-----------|
| Models | `~/.cursor/skills/django-expert/references/models-orm.md` | Creating models, ORM queries, optimization |
| Serializers | `~/.cursor/skills/django-expert/references/drf-serializers.md` | DRF serializers, validation |
| ViewSets | `~/.cursor/skills/django-expert/references/viewsets-views.md` | Views, viewsets, async views |
| Authentication | `~/.cursor/skills/django-expert/references/authentication.md` | JWT, permissions, SimpleJWT |
| Testing | `~/.cursor/skills/django-expert/references/testing-django.md` | APITestCase, fixtures, factories |
