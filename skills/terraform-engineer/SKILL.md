...
|-------|-----------|-----------|
| Modules | `~/.cursor/skills/terraform-engineer/references/module-patterns.md` | Creating modules, inputs/outputs, versioning |
| State | `~/.cursor/skills/terraform-engineer/references/state-management.md` | Remote backends, locking, workspaces, migrations |
| Providers | `~/.cursor/skills/terraform-engineer/references/providers.md` | AWS/Azure/GCP configuration, authentication |
| Testing | `~/.cursor/skills/terraform-engineer/references/testing.md` | terraform plan, terratest, policy as code |
| Best Practices | `~/.cursor/skills/terraform-engineer/references/best-practices.md` | DRY patterns, naming, security, cost tracking |
